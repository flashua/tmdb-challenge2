...
export default class Splash extends Lightning.Component {
  ...
  _init() {
    const timeQuants = 8;
    this._quantLength = 1 / timeQuants;
    this._rotations = Array(timeQuants + 1)
      .fill((2 * Math.PI) / timeQuants)
      .reduce((rotations, rotationAngle, index) => [...rotations, index * rotationAngle], []);
      ...
      actions: [
        {
          ...
          sm: 0,
          v: timePoint =>
            this._rotations[Math.floor(timePoint / this._quantLength)]
        }
      ]
    });
  }
